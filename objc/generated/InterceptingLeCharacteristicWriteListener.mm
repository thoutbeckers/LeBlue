...
- (void)leCharacteristicWrittenWithJavaUtilUUID:(JavaUtilUUID *)uuid
  ...
  if (leCharacteristicWriteListener_ != nil) {
    [leCharacteristicWriteListener_ leCharacteristicWrittenWithJavaUtilUUID:uuid withJavaUtilUUID:serviceUuid withLeRemoteDevice:iLeRemoteDevice withLeGattCharacteristic:iLeGattCharacteristic withBoolean:success];
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LLeCharacteristicWriteListener;LLeInterceptor;", "leCharacteristicWritten", "LJavaUtilUUID;LJavaUtilUUID;LLeRemoteDevice;LLeGattCharacteristic;Z", (void *)&InterceptingLeCharacteristicWriteListener__Annotations$0, "equals", "LNSObject;", "hashCode" };
