...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(leCharacteristicChangedWithJavaUtilUUID:withJavaUtilUUID:withLeRemoteDevice:withLeGattCharacteristic:);
  methods[1].selector = @selector(leCharacteristicNotificationChangedWithJavaUtilUUID:withJavaUtilUUID:withLeRemoteDevice:withLeGattCharacteristic:withBoolean:);
  #pragma clang diagnostic pop
  static const void *ptrTable[] = { "leCharacteristicChanged", "LJavaUtilUUID;LJavaUtilUUID;LLeRemoteDevice;LLeGattCharacteristic;", (void *)&LeCharacteristicListener__Annotations$0, "leCharacteristicNotificationChanged", "LJavaUtilUUID;LJavaUtilUUID;LLeRemoteDevice;LLeGattCharacteristic;Z", (void *)&LeCharacteristicListener__Annotations$1 };
