...
+ (void)initialize {
  if (self == [LeGattStatus class]) {
    JreEnum(LeGattStatus, SUCCESS) = new_LeGattStatus_initWithNSString_withInt_(JreEnumConstantName(LeGattStatus_class_(), 0), 0);
    JreEnum(LeGattStatus, READ_NOT_PERMITTED) = new_LeGattStatus_initWithNSString_withInt_(JreEnumConstantName(LeGattStatus_class_(), 1), 1);
    JreEnum(LeGattStatus, WRITE_NOT_PERMITTED) = new_LeGattStatus_initWithNSString_withInt_(JreEnumConstantName(LeGattStatus_class_(), 2), 2);
    JreEnum(LeGattStatus, INSUFFICIENT_AUTHENTICATION) = new_LeGattStatus_initWithNSString_withInt_(JreEnumConstantName(LeGattStatus_class_(), 3), 3);
    JreEnum(LeGattStatus, REQUEST_NOT_SUPPORTED) = new_LeGattStatus_initWithNSString_withInt_(JreEnumConstantName(LeGattStatus_class_(), 4), 4);
    JreEnum(LeGattStatus, INSUFFICIENT_ENCRYPTION) = new_LeGattStatus_initWithNSString_withInt_(JreEnumConstantName(LeGattStatus_class_(), 5), 5);
    JreEnum(LeGattStatus, INVALID_OFFSET) = new_LeGattStatus_initWithNSString_withInt_(JreEnumConstantName(LeGattStatus_class_(), 6), 6);
    JreEnum(LeGattStatus, INVALID_ATTRIBUTE_LENGTH) = new_LeGattStatus_initWithNSString_withInt_(JreEnumConstantName(LeGattStatus_class_(), 7), 7);
    JreEnum(LeGattStatus, FAILURE) = new_LeGattStatus_initWithNSString_withInt_(JreEnumConstantName(LeGattStatus_class_(), 8), 8);
