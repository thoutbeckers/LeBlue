...
- (void)startSessionWithNSString:(NSString *)sessionName {
  ...
  @try {
    ...
    [((id<JavaUtilConcurrentLocksCondition>) nil_chk(condition_)) signalAll];
    [new_JavaLangThread_initWithJavaLangRunnable_(new_LeSessionController_1_initWithLeSessionController_(self)) start];
  }
  @finally {
    [lock_ unlock];
  }
...
- (void)startSessionInThread {
  ...
  @try {
    ...
    @catch (JavaLangException *e) {
      sessionException_ = e;
      @throw new_JavaLangRuntimeException_initWithNSString_withJavaLangThrowable_(JreStrcat("$@", @"error processing session at event ", event), e);
    }
    @finally {
  ...
  switch ([(LeEventType *) cast_chk(((Event *) nil_chk(event))->type_, [LeEventType class]) ordinal]) {
    ...
    [self checkPause];
    {
      ...
      switch ([(LeEventType *) cast_chk(event->type_, [LeEventType class]) ordinal]) {
        ...
        [self runCurrentEventOnUiThreadWithJavaLangRunnable:new_LeSessionController_2_initWithLeSessionController_withEvent_(self, event)];
        break;
        case LeEventType_Enum_remoteDeviceFound:
        [self runCurrentEventOnUiThreadWithJavaLangRunnable:new_LeSessionController_3_initWithLeSessionController_withEvent_(self, event)];
        break;
        case LeEventType_Enum_mockRemoteDeviceConnected:
        {
          ...
          while (b__ < e__) {
            ...
            [self runCurrentEventOnUiThreadWithJavaLangRunnable:new_LeSessionController_4_initWithLeSessionController_withLeRemoteDeviceListener_withEvent_(self, listener, event)];
          }
        }
        break;
        case LeEventType_Enum_remoteDeviceConnected:
        [self runCurrentEventOnUiThreadWithJavaLangRunnable:new_LeSessionController_5_initWithLeSessionController_withEvent_(self, event)];
        break;
        case LeEventType_Enum_mockRemoteDeviceDisconnected:
        {
          ...
          while (b__ < e__) {
            id<LeRemoteDeviceListener> leRemoteListener = *b__++;
            id<LeRemoteDeviceListener> listener = leRemoteListener;
            [self runCurrentEventOnUiThreadWithJavaLangRunnable:new_LeSessionController_6_initWithLeSessionController_withLeRemoteDeviceListener_withEvent_(self, listener, event)];
          }
        }
        break;
        case LeEventType_Enum_remoteDeviceDisconnected:
        [self runCurrentEventOnUiThreadWithJavaLangRunnable:new_LeSessionController_7_initWithLeSessionController_withEvent_(self, event)];
        break;
        case LeEventType_Enum_mockRemoteDeviceClosed:
        {
          ...
          while (b__ < e__) {
            id<LeRemoteDeviceListener> leRemoteListener = *b__++;
            id<LeRemoteDeviceListener> listener = leRemoteListener;
            [self runCurrentEventOnUiThreadWithJavaLangRunnable:new_LeSessionController_8_initWithLeSessionController_withLeRemoteDeviceListener_withEvent_(self, listener, event)];
          }
        }
        break;
        case LeEventType_Enum_remoteDeviceClosed:
        [self runCurrentEventOnUiThreadWithJavaLangRunnable:new_LeSessionController_9_initWithLeSessionController_withEvent_(self, event)];
        break;
        case LeEventType_Enum_mockRemoteDeviceServicesDiscovered:
        {
          ...
          while (b__ < e__) {
            id<LeRemoteDeviceListener> leRemoteListener = *b__++;
            id<LeRemoteDeviceListener> listener = leRemoteListener;
            [self runCurrentEventOnUiThreadWithJavaLangRunnable:new_LeSessionController_10_initWithLeSessionController_withEvent_withLeRemoteDeviceListener_(self, event, listener)];
          }
        }
        break;
        case LeEventType_Enum_remoteDeviceServicesDiscovered:
        [self runCurrentEventOnUiThreadWithJavaLangRunnable:new_LeSessionController_11_initWithLeSessionController_withEvent_(self, event)];
        break;
        case LeEventType_Enum_remoteDeviceRssiRead:
        [self runCurrentEventOnUiThreadWithJavaLangRunnable:new_LeSessionController_12_initWithLeSessionController_withEvent_(self, event)];
        break;
        ...
        [self runCurrentEventOnUiThreadWithJavaLangRunnable:new_LeSessionController_13_initWithLeSessionController_withEvent_withJavaUtilUUID_withLeGattCharacteristic_(self, event, uuid, characteristic)];
        break;
        case LeEventType_Enum_characteristicChanged:
        [self runCurrentEventOnUiThreadWithJavaLangRunnable:new_LeSessionController_14_initWithLeSessionController_withEvent_(self, event)];
        break;
        case LeEventType_Enum_characteristicWritten:
        [self runCurrentEventOnUiThreadWithJavaLangRunnable:new_LeSessionController_15_initWithLeSessionController_withEvent_(self, event)];
        break;
        ...
        [self runCurrentEventOnUiThreadWithJavaLangRunnable:new_LeSessionController_16_initWithLeSessionController_withEvent_withJavaUtilUUID_withLeGattCharacteristic_(self, event, uuid2, characteristic2)];
        break;
        case LeEventType_Enum_characteristicNotificationChanged:
        [self runCurrentEventOnUiThreadWithJavaLangRunnable:new_LeSessionController_17_initWithLeSessionController_withEvent_(self, event)];
        break;
        default:
        switch ([(LeEventType *) cast_chk(event->type_, [LeEventType class]) ordinal]) {
...
void LeSessionController_initWithSession_withBoolean_(LeSessionController *self, id<Session> session, jboolean strict) {
  ...
  (void) JreVolatileStrongAssign(&self->mockedEvents_, new_JavaUtilArrayList_init());
...
- (void)run {
  {
    ...
    while (b__ < e__) {
      ...
      [((id<LeCharacteristicListener>) nil_chk(leCharacteristicListener)) leCharacteristicChangedWithJavaUtilUUID:val$uuid_ withJavaUtilUUID:nil withLeRemoteDevice:[this$0_ getRemoteDeviceWithInt:val$event_->source_] withLeGattCharacteristic:val$characteristic_];
    }
  }
}
...
- (void)run {
  ...
  [((id<LeCharacteristicWriteListener>) nil_chk(characteristicWriteListener)) leCharacteristicWrittenWithJavaUtilUUID:uuid withJavaUtilUUID:nil withLeRemoteDevice:[this$0_ getRemoteDeviceWithNSString:IOSObjectArray_Get(nil_chk(val$event_->values_), 1)] withLeGattCharacteristic:[this$0_ getCharacteristicWithNSString:IOSObjectArray_Get(nil_chk(val$event_->values_), 2)] withBoolean:true];
}
...
- (void)run {
  {
    ...
    while (b__ < e__) {
      id<LeCharacteristicListener> leCharacteristicListener = *b__++;
      [((id<LeCharacteristicListener>) nil_chk(leCharacteristicListener)) leCharacteristicNotificationChangedWithJavaUtilUUID:val$uuid2_ withJavaUtilUUID:nil withLeRemoteDevice:[this$0_ getRemoteDeviceWithNSString:IOSObjectArray_Get(nil_chk(val$event_->values_), 2)] withLeGattCharacteristic:val$characteristic2_ withBoolean:JavaLangBoolean_parseBooleanWithNSString_(IOSObjectArray_Get(nil_chk(val$event_->values_), 3))];
    }
  }
}
...
+ (void)initialize {
  if (self == [LeSessionController_SourceType class]) {
    JreEnum(LeSessionController_SourceType, device) = new_LeSessionController_SourceType_initWithNSString_withInt_(JreEnumConstantName(LeSessionController_SourceType_class_(), 0), 0);
    JreEnum(LeSessionController_SourceType, remoteDevice) = new_LeSessionController_SourceType_initWithNSString_withInt_(JreEnumConstantName(LeSessionController_SourceType_class_(), 1), 1);
    JreEnum(LeSessionController_SourceType, gattService) = new_LeSessionController_SourceType_initWithNSString_withInt_(JreEnumConstantName(LeSessionController_SourceType_class_(), 2), 2);
    JreEnum(LeSessionController_SourceType, gattCharacteristic) = new_LeSessionController_SourceType_initWithNSString_withInt_(JreEnumConstantName(LeSessionController_SourceType_class_(), 3), 3);
