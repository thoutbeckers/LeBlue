...
- (RemoteDeviceMockerObject *)mocksRemoteDeviceWithInt:(jint)deviceId
  ...
  (void) [self withMockWithEventType:JreLoadEnum(LeEventType, remoteDeviceGetAddress) withNSString:address];
  (void) [self withMockWithEventType:JreLoadEnum(LeEventType, remoteDeviceGetName) withNSString:name];
  if (connects) {
    (void) [self withMockWithEventType:JreLoadEnum(LeEventType, remoteDeviceConnect) withMockedResponse:new_MockedResponseObject_initWithEvent_(new_Event_initWithEventType_withInt_withInt_withNSStringArray_(JreLoadEnum(LeEventType, mockRemoteDeviceConnected), [self getDelay], sessionSource_, [IOSObjectArray newArrayWithObjects:(id[]){ JreStrcat("I", deviceId) } count:1 type:NSString_class_()]))];
    (void) [self withMockWithEventType:JreLoadEnum(LeEventType, remoteDeviceDisconnect) withMockedResponse:new_MockedResponseObject_initWithEvent_(new_Event_initWithEventType_withInt_withInt_withNSStringArray_(JreLoadEnum(LeEventType, mockRemoteDeviceDisconnected), [self getDelay], sessionSource_, [IOSObjectArray newArrayWithObjects:(id[]){ JreStrcat("I", deviceId) } count:1 type:NSString_class_()]))];
    (void) [self withMockWithEventType:JreLoadEnum(LeEventType, remoteDeviceClose) withMockedResponse:new_MockedResponseObject_initWithEvent_(new_Event_initWithEventType_withInt_withInt_withNSStringArray_(JreLoadEnum(LeEventType, mockRemoteDeviceClosed), [self getDelay], sessionSource_, [IOSObjectArray newArrayWithObjects:(id[]){ JreStrcat("I", deviceId) } count:1 type:NSString_class_()]))];
  }
  return self;
}
...
- (RemoteDeviceMockerObject *)hasServicesWithLeGattStatus:(LeGattStatus *)status
  ...
  (void) [self withMockWithEventType:JreLoadEnum(LeEventType, remoteDeviceStartServiceDiscovery) withMockedResponse:new_MockedResponseObject_initWithEvent_(new_Event_initWithEventType_withInt_withInt_withNSStringArray_(JreLoadEnum(LeEventType, mockRemoteDeviceServicesDiscovered), [self getDelay], sessionSource_, [params toArrayWithNSObjectArray:[IOSObjectArray newArrayWithLength:[params size] type:NSString_class_()]]))];
  return self;
}
