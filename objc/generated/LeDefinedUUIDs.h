...
@property (readonly, class) JavaUtilUUID *HEART_RATE NS_SWIFT_NAME(HEART_RATE);
@property (readonly, class) JavaUtilUUID *CYCLING_POWER NS_SWIFT_NAME(CYCLING_POWER);
@property (readonly, class) JavaUtilUUID *CYCLING_SPEED_AND_CADENCE NS_SWIFT_NAME(CYCLING_SPEED_AND_CADENCE);
@property (readonly, class) JavaUtilUUID *RUNNING_SPEED_AND_CADENCE NS_SWIFT_NAME(RUNNING_SPEED_AND_CADENCE);
@property (readonly, class) JavaUtilUUID *FITNESS_MACHINE NS_SWIFT_NAME(FITNESS_MACHINE);
@property (readonly, class) JavaUtilUUID *BATTERY NS_SWIFT_NAME(BATTERY);
@property (readonly, class) JavaUtilUUID *DEVICE_INFORMATION NS_SWIFT_NAME(DEVICE_INFORMATION);
@property (readonly, class) JavaUtilUUID *GENERIC_ATTRIBUTE NS_SWIFT_NAME(GENERIC_ATTRIBUTE);
@property (readonly, class) JavaUtilUUID *GENERIC_ACCESS NS_SWIFT_NAME(GENERIC_ACCESS);
...
@property (readonly, class) JavaUtilUUID *HEART_RATE_MEASUREMENT NS_SWIFT_NAME(HEART_RATE_MEASUREMENT);
@property (readonly, class) JavaUtilUUID *MANUFACTURER_STRING NS_SWIFT_NAME(MANUFACTURER_STRING);
@property (readonly, class) JavaUtilUUID *MODEL_NUMBER_STRING NS_SWIFT_NAME(MODEL_NUMBER_STRING);
@property (readonly, class) JavaUtilUUID *SERIAL_NUMBER_STRING NS_SWIFT_NAME(SERIAL_NUMBER_STRING);
@property (readonly, class) JavaUtilUUID *FIRMWARE_REVISION_STRING NS_SWIFT_NAME(FIRMWARE_REVISION_STRING);
@property (readonly, class) JavaUtilUUID *HARDWARE_REVISION_STRING NS_SWIFT_NAME(HARDWARE_REVISION_STRING);
@property (readonly, class) JavaUtilUUID *APPEARANCE NS_SWIFT_NAME(APPEARANCE);
@property (readonly, class) JavaUtilUUID *BODY_SENSOR_LOCATION NS_SWIFT_NAME(BODY_SENSOR_LOCATION);
@property (readonly, class) JavaUtilUUID *BATTERY_LEVEL NS_SWIFT_NAME(BATTERY_LEVEL);
@property (readonly, class) JavaUtilUUID *SENSOR_LOCATION NS_SWIFT_NAME(SENSOR_LOCATION);
@property (readonly, class) JavaUtilUUID *CYCLING_POWER_MEASUREMENT NS_SWIFT_NAME(CYCLING_POWER_MEASUREMENT);
@property (readonly, class) JavaUtilUUID *CYCLING_POWER_VECTOR NS_SWIFT_NAME(CYCLING_POWER_VECTOR);
@property (readonly, class) JavaUtilUUID *CYCLING_POWER_FEATURE NS_SWIFT_NAME(CYCLING_POWER_FEATURE);
@property (readonly, class) JavaUtilUUID *CYCLING_POWER_CONTROL_POINT NS_SWIFT_NAME(CYCLING_POWER_CONTROL_POINT);
@property (readonly, class) JavaUtilUUID *CSC_MEASUREMENT NS_SWIFT_NAME(CSC_MEASUREMENT);
@property (readonly, class) JavaUtilUUID *CSC_FEATURE NS_SWIFT_NAME(CSC_FEATURE);
@property (readonly, class) JavaUtilUUID *SERVICE_CHANGED NS_SWIFT_NAME(SERVICE_CHANGED);
@property (readonly, class) JavaUtilUUID *FITNESS_MACHINE_FEATURE NS_SWIFT_NAME(FITNESS_MACHINE_FEATURE);
@property (readonly, class) JavaUtilUUID *INDOOR_BIKE_DATA NS_SWIFT_NAME(INDOOR_BIKE_DATA);
@property (readonly, class) JavaUtilUUID *TRAINING_STATUS NS_SWIFT_NAME(TRAINING_STATUS);
@property (readonly, class) JavaUtilUUID *SUPPORTED_SPEED_RANGE NS_SWIFT_NAME(SUPPORTED_SPEED_RANGE);
@property (readonly, class) JavaUtilUUID *SUPPORTED_INCLINATION_RANGE NS_SWIFT_NAME(SUPPORTED_INCLINATION_RANGE);
@property (readonly, class) JavaUtilUUID *SUPPORTED_RESISTANCE_LEVEL_RANGE NS_SWIFT_NAME(SUPPORTED_RESISTANCE_LEVEL_RANGE);
@property (readonly, class) JavaUtilUUID *SUPPORTED_HEART_RATE_RANGE NS_SWIFT_NAME(SUPPORTED_HEART_RATE_RANGE);
@property (readonly, class) JavaUtilUUID *SUPPORTED_POWER_RANGE NS_SWIFT_NAME(SUPPORTED_POWER_RANGE);
@property (readonly, class) JavaUtilUUID *FITNESS_MACHINE_CONTROL_POINT NS_SWIFT_NAME(FITNESS_MACHINE_CONTROL_POINT);
@property (readonly, class) JavaUtilUUID *FITNESS_MACHINE_STATUS NS_SWIFT_NAME(FITNESS_MACHINE_STATUS);
@property (readonly, class) JavaUtilUUID *DEVICE_NAME NS_SWIFT_NAME(DEVICE_NAME);
...
@property (readonly, class) JavaUtilUUID *CHAR_CLIENT_CONFIG NS_SWIFT_NAME(CHAR_CLIENT_CONFIG);
