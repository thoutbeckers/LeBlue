...
- (void)leCharacteristicChangedWithJavaUtilUUID:(JavaUtilUUID * __nonnull)characteristicUUID
...
- (void)leCharacteristicNotificationChangedWithJavaUtilUUID:(JavaUtilUUID * __nonnull)characteristicUUID
                                           withJavaUtilUUID:(JavaUtilUUID * __nonnull)serviceUUID
                                         withLeRemoteDevice:(id<LeRemoteDevice> __nonnull)remoteDevice
                                   withLeGattCharacteristic:(id<LeGattCharacteristic> __nonnull)characteristic
