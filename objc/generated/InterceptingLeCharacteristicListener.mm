...
- (void)leCharacteristicChangedWithJavaUtilUUID:(JavaUtilUUID *)uuid
  ...
  if (leCharacteristicListener_ != nil) {
    [leCharacteristicListener_ leCharacteristicChangedWithJavaUtilUUID:uuid withJavaUtilUUID:serviceUuid withLeRemoteDevice:iLeRemoteDevice withLeGattCharacteristic:iLeGattCharacteristic];
  }
...
- (void)leCharacteristicNotificationChangedWithJavaUtilUUID:(JavaUtilUUID *)uuid
  ...
  InterceptingLeGattCharacteristic *iLeGattCharacteristic = [leInterceptor_ getInterceptingLeGattCharacteristicWithLeGattCharacteristic:characteristic];
  if (leCharacteristicListener_ != nil) {
    [leCharacteristicListener_ leCharacteristicNotificationChangedWithJavaUtilUUID:uuid withJavaUtilUUID:serviceUuid withLeRemoteDevice:iLeRemoteDevice withLeGattCharacteristic:iLeGattCharacteristic withBoolean:success];
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LLeCharacteristicListener;LLeInterceptor;", "leCharacteristicChanged", "LJavaUtilUUID;LJavaUtilUUID;LLeRemoteDevice;LLeGattCharacteristic;", (void *)&InterceptingLeCharacteristicListener__Annotations$0, "leCharacteristicNotificationChanged", "LJavaUtilUUID;LJavaUtilUUID;LLeRemoteDevice;LLeGattCharacteristic;Z", (void *)&InterceptingLeCharacteristicListener__Annotations$1, "equals", "LNSObject;", "hashCode" };
...
IOSObjectArray *InterceptingLeCharacteristicListener__Annotations$1() {
  return [IOSObjectArray newArrayWithObjects:(id[]){ [IOSObjectArray newArrayWithObjects:(id[]){ create_JavaxAnnotationNonnull(JreLoadEnum(JavaxAnnotationMetaWhen, ALWAYS)) } count:1 type:JavaLangAnnotationAnnotation_class_()], [IOSObjectArray newArrayWithObjects:(id[]){ create_JavaxAnnotationNonnull(JreLoadEnum(JavaxAnnotationMetaWhen, ALWAYS)) } count:1 type:JavaLangAnnotationAnnotation_class_()], [IOSObjectArray newArrayWithObjects:(id[]){ create_JavaxAnnotationNonnull(JreLoadEnum(JavaxAnnotationMetaWhen, ALWAYS)) } count:1 type:JavaLangAnnotationAnnotation_class_()], [IOSObjectArray newArrayWithObjects:(id[]){ create_JavaxAnnotationNonnull(JreLoadEnum(JavaxAnnotationMetaWhen, ALWAYS)) } count:1 type:JavaLangAnnotationAnnotation_class_()], [IOSObjectArray newArrayWithLength:0 type:JavaLangAnnotationAnnotation_class_()] } count:5 type:IOSClass_arrayType(JavaLangAnnotationAnnotation_class_(), 1)];
}
